...
def simulate_scenes(
    ...
    batch, modular_robot_to_multi_body_system_mappings, modular_robot_to_module_maps = to_batch(
    ...
    results = [
        [
            SceneSimulationState(state, modular_robot_to_multi_body_system_mapping, modular_robot_to_module_map)
            for state in simulation_result
        ]
        for simulation_result, modular_robot_to_multi_body_system_mapping, modular_robot_to_module_map in zip(
            simulation_results, modular_robot_to_multi_body_system_mappings, modular_robot_to_module_maps, strict=True
        )
    ]
