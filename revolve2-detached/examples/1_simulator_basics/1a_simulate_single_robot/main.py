...
def main() -> None:
    ...
    batch_parameters.simulation_time = 9999  # Here we update our simulation time.
    # import pandas as pd
    # from pprint import pprint; pprint(brain._weight_matrix)
    # pd.DataFrame(brain._weight_matrix).to_csv("weights.csv")
