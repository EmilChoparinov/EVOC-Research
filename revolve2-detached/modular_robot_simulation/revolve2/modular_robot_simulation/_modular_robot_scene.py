...
class ModularRobotScene:
    ...
    def to_simulation_scene(
        self,
    ) -> tuple[Scene, dict[UUIDKey[ModularRobot], MultiBodySystem], dict[UUIDKey[ModularRobot], BodyToMultiBodySystemMapping]]:
        """
        ...
        modular_robot_to_body_to_multi_body_system_mapping: dict[
            UUIDKey[ModularRobot], BodyToMultiBodySystemMapping
        ] = {}
        ...
        for robot, pose, translate_z_aabb in self._robots:
            ...
            modular_robot_to_body_to_multi_body_system_mapping[UUIDKey(robot)] = (
                body_to_multi_body_system_mapping
            )
        ...
        return scene, modular_robot_to_multi_body_system_mapping, modular_robot_to_body_to_multi_body_system_mapping
