...
class SceneSimulationState:
    ...
    def __init__(
        ...
        self._modular_robot_to_multi_body_system_mapping = modular_robot_to_multi_body_system_mapping
        self.modular_robot_to_module_map = modular_robot_to_module_map
    ...
    def get_modular_robot_simulation_state(
        ...
        return ModularRobotSimulationState(
            ...
            self.modular_robot_to_module_map[UUIDKey(modular_robot)]
        )
