...
async def _run_remote_impl(
    ...
    # print("hardware_type", hardware_type)
    # print("pin_controls", pin_controls)
    # print("config.initial_hinge_positions: ", config.initial_hinge_positions)
    match hardware_type:
        ...
        match hardware_type:
            ...
            case HardwareType.v2:
                ...
                sensor_state = ModularRobotSensorStateImplV2(
                    ...
                    positions={
                        pin: position
                        for pin, position in zip(pins, pins)
                    },
                )
            case _:
